    ...
    for (let i = 0; i < rotation.length; i++) {
        ...
        if (skillKey === ECHO_STEP_KEY) {
            ...
            if (!resolved) {
                ...
                energyTrace.push({ stepIndex: i, energyBefore: energyCursor, energyAfter: energyCursor, liberationCastable: null, rawGen: 0, isLiberation: false });
                cursor += castTime;
                continue;
            }
        ...
        energyTrace.push({
            ...
            rawGen, isLiberation: skillDef.skillType === 'liberation',
        });
